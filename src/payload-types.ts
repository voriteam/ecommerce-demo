...
export interface Config {
  ...
  globalsSelect: {
    ...
    voriSync: VoriSyncSelect<false> | VoriSyncSelect<true>;
  ...
  jobs: {
    tasks: {
      syncVoriInventory: TaskSyncVoriInventory;
      recordVoriTransaction: TaskRecordVoriTransaction;
      inline: {
        input: unknown;
        output: unknown;
      };
...
export interface Order {
   ...
   */
  voriTransactionId?: string | null;
  /**
   * Whether this order has been recorded in Vori.
   */
  voriSyncStatus?: ('pending' | 'recorded' | 'conflict' | 'failed' | 'skipped') | null;
  voriSyncedAt?: string | null;
  voriSyncError?: string | null;
  voriRequestBody?:
    | {
        [k: string]: unknown;
      }
...
export interface Product {
   ...
   */
  voriStoreProductId?: string | null;
  voriStoreId?: string | null;
  /**
   * UPC or PLU as scanned at the register.
   */
  voriBarcode?: string | null;
  voriDepartmentId?: string | null;
  /**
   * When the inventory poll last wrote this product’s on-hand quantity.
   */
  voriInventorySyncedAt?: string | null;
  /**
  ...
  ebtEnabled?: boolean | null;
  wicEnabled?: boolean | null;
  /**
   * Minimum age required to buy, when the product is age-restricted.
   */
  minCustomerAge?: number | null;
  /**
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'syncVoriInventory' | 'recordVoriTransaction';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'syncVoriInventory' | 'recordVoriTransaction') | null;
  queue?: string | null;
...
export interface ProductsSelect<T extends boolean = true> {
  ...
  generateSlug?: T;
  slug?: T;
  voriStoreProductId?: T;
  voriStoreId?: T;
  voriBarcode?: T;
  voriDepartmentId?: T;
  voriInventorySyncedAt?: T;
  soldByWeight?: T;
  ebtEnabled?: T;
  wicEnabled?: T;
  minCustomerAge?: T;
 ...
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "voriSync".
 */
export interface VoriSync {
  id: number;
  /**
  ...
  /**
   * Products whose on-hand quantity changed in the most recent run.
   */
  lastRunProductsUpdated?: number | null;
  /**
   * Inventory records returned by Vori in the most recent run, including products this storefront does not carry.
   */
  lastRunRecordsSeen?: number | null;
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "voriSync_select".
 */
export interface VoriSyncSelect<T extends boolean = true> {
  watermark?: T;
  nextWatermark?: T;
  cursor?: T;
  lastRunAt?: T;
  lastRunProductsUpdated?: T;
  lastRunRecordsSeen?: T;
  lastError?: T;
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskSyncVoriInventory".
 */
export interface TaskSyncVoriInventory {
  input?: unknown;
  output: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskRecordVoriTransaction".
 */
export interface TaskRecordVoriTransaction {
  input: {
    orderId: string;
  };
  output: {
