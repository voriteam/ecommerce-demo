import type { VoriStoreProduct } from '../mapping'
...
const base: VoriStoreProduct = {
  ...
  inventory: { current: '24', last_changed_at: '2026-08-18T21:40:00.000Z', max_stock: null, min_par: null },
...
export const weightPricedProduct: VoriStoreProduct = {
  ...
  ebt_enabled: true,
  inventory: { current: '112.4', last_changed_at: '2026-08-18T21:41:00.000Z', max_stock: null, min_par: null },
  name: 'Bananas',
  retail_price: '0.69',
  sold_by_weight: true,
  wic_enabled: false,
...
export const taxedProduct: VoriStoreProduct = {
  ...
  ebt_enabled: false,
  inventory: { current: '6', last_changed_at: '2026-08-18T21:42:00.000Z', max_stock: null, min_par: null },
  min_customer_age: 21,
  name: 'Lagunitas IPA 6-Pack',
  retail_price: '12.49',
  tax_rates: [
    { id: '77', category: 'sales', name: 'CA State Sales Tax', value: '8.25', value_type: 'percentage' },
  ],
  wic_enabled: false,
}
...
export const oversoldProduct: VoriStoreProduct = {
  ...base,
  id: '900004',
  inventory: { current: '-3', last_changed_at: '2026-08-18T21:43:00.000Z', max_stock: null, min_par: null },
  name: 'Sourdough Loaf',
  retail_price: '6.50',
}
